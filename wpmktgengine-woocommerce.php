        ...
        if (class_exists("woocommerce") || class_exists("Woocommerce")) {
            ...
            function checkout_update_meta($order_id, $data)
            {
                ...
                if (
                    ...
                    $cartOrder->changed->email_ordered_from =
                        $cartAddress["email"];
                    ...
                    foreach ($subscriptions_ids as $subscriptions_id):
                        ...
                        if ($getrenewal && $manual == "false"):
                            ...
                            if (isset($WPME_API) && !empty($id)) {
                                ...
                                $cartOrder->action = "subrenewal";

                                $cartOrder->changed->action = "subrenewal";
...
if (!function_exists("mv_save_wc_order_other_fields")) {
    ...
    isset(WC()->session->{WPMKTENGINE_ORDER_KEY}) && \WPME\Helper::canContinue()) {
        ...
        //email_ordered_from = email address making the sale
           ...
           $cartOrder->order_date = "$order->date_created";
    
           $cartOrder->completed_date = "$order->date_created";
    
           $cartOrder->order_shipped = "$order->date_created";
               ...
               if (!empty($subscriptions_ids) && !$getrenewal):
                 ...
                 $subscription_product_name = get_wpme_subscription_activity_name(
                   ...
                   if (!empty($subscriptions_ids) && !$getrenewal)  {
                    ...
                    $update_cart = $WPME_API->updateCart($result->order_id, $cartOrder->getPayload());
